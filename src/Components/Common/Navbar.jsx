...
const Navbar = () => {
  ...
  return (
    ...
    <>
        ...
        <div className="flex sticky top-0 z-50 justify-between bg-[#154253] p-3 ">
        ...
        <div className="flex items-center justify-center gap-3">
            ...
            <img src={logo} alt="GarnikEmpireLogo" className="h-[50px] w-[50px] ml-8"/>
        ...
        <div className="flex items-center justify-center gap-4 mr-14 text-[20px]">
